...
protected:
	FORCEINLINE static void LimitDisplacement(float& BoneLocation, const float TargetPos, const bool bLimitMinTranslation, const bool bLimitMaxTranslation, const float MinTranslationLimit, const float MaxTranslationLimit)
	{
